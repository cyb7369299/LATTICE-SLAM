...
#define if_omit_outlframe   false   // This will be done in the Back-End
...
bool unit_node::lsr_isoutof_ranges(Eigen::Vector2f lsrfxy, Eigen::Vector2f *fcorners)
{   
    /*
    ...
    */
    ...
    #if if_omit_outlframe == true

        #define xrange0 fcorners[0](0)
        #define xrange1 fcorners[2](0)
        #define yrange0 fcorners[0](1)
        #define yrange1 fcorners[2](1)

        if( (lsrfxy(0)<xrange0) || (lsrfxy(0)>xrange1) ||
            (lsrfxy(1)<yrange0) || (lsrfxy(1)>yrange1)) 
            return true;
        ...
        for(i=0; i<lsr_in->lsrdta_size; i++)
        {
              ...
              )
            {
  ...
  
                {
                    ...
                    nmap[lid] = base_node.nmap[lid1];

                    if(base_node.nmap_obs_chart[lid1] == true)
                    {
