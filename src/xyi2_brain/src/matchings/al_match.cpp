                                   ...
                                   sensor_msgs::LaserScanConstPtr &lsr_data)
{
    ...
    if(Almatch_Paraminit)
    {
        ...
        // **********************************************************************************
        static Eigen::Matrix4d mat_d_odom, mat_d_source2lsr;
            ...
            case match_slammap:
                ...
                */
...

                {
                    ...
                    {
                        static Eigen::Matrix4d mat_d_source2lsr_extra;

                        AlMatch_LoopMapping();

                        mat_d_source2lsr_extra = H_akey_node.mat_source2lsr * MCor_matxz;

                        AlMatch_LoopDeal(mat_d_source2lsr,
                                         mat_d_source2lsr_extra);
